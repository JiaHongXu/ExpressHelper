...
+ (NSString *)formatUrl:(NSString *)url {
    url = [url stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];//对url进行UTF-8编码，解决中文问题
    //    url = [url stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    url = [url stringByReplacingOccurrencesOfString:@" " withString:@"%20"];//对url中的空格进行处理
    url = [url stringByReplacingOccurrencesOfString:@"+" withString:@"%252B"];//对url中的加号
    return url;
}
